...
static const char *fonts[] = {
    "JetBrainsMono Nerd Font Mono:style=Bold:size=11",
};
...
static const char *screenshotcmd[] = { "/bin/sh", "-c", "maim -s | tee ~/Pictures/Screenshots/$(date +%s).png | xclip -selection clipboard -t image/png", NULL };
static const char *rofi[]  = { "rofi", "-show", "drun", "-theme", NULL };
static const char *emoji[] = { "x11-emoji-picker", NULL};
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_w,      spawn,          SHCMD("~/scripts/wallpicker.sh") },
	{ MODKEY,                       XK_Escape, spawn,          SHCMD("wlogout") },
...
static const Key leaderkeys[21] = {
